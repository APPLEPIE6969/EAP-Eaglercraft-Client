#!/bin/bash
# ============================================================================
# EaglerCraft 26.2 - Full Build Pipeline
# ============================================================================
...
show_help() {
    echo "EaglerCraft 26.2 - Full Build Pipeline"
    echo ""
    ...
    echo ""
    echo "Build Pipeline:"
    echo "  1. Initialize  - Decompile MC 26.2, apply patches"
...
main() {
    ...
    echo "╚══════════════════════════════════════════════════════════╝"
    echo ""
    success "EaglerCraft 26.2 build complete!"
}
