...
> Complete guide to building EaglercraftX 26.2 from source.
...
|------|---------|-------------|
| **Minecraft 26.2 JAR** | Base game source (unobfuscated) | Official Minecraft launcher |
| **Minecraft 26.2 assets** | Textures, sounds, lang files | Downloaded during build |
...
```
╔══════════════════════════════════════════════════════════╗
║         EaglercraftX 26.2 Build Initialization        ║
╠══════════════════════════════════════════════════════════╣
║                                                          ║
║  This script will set up the build environment.          ║
║  You need the Minecraft 26.2 vanilla JAR.             ║
║                                                          ║
║  Enter the path to your Minecraft 26.2 JAR:           ║
║  > /home/user/.minecraft/versions/26.2/26.2.jar    ║
║                                                          ║
...
**Solution:** 
1. Check if you have the correct MC 26.2 JAR
...
RUN ./build_init.sh --non-interactive --jar=/build/minecraft-26.2.jar
  ...
  build:
    ...
    steps:
      ...
      - name: Initialize build
        run: ./build_init.sh --non-interactive --jar=minecraft-26.2.jar
