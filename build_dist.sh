#!/bin/bash
# ============================================================================
# EaglerCraft 26.2 - Create Distribution
# ============================================================================
...
show_help() {
    echo "EaglerCraft 26.2 - Create Distribution"
    echo ""
...
create_signed_client() {
    ...
    echo "# EaglerCraft 26.2 Signed Client Manifest" > "$manifest_file"
    echo "# Generated: $(date -u +%Y-%m-%dT%H:%M:%SZ)" >> "$manifest_file"
    echo "# Version: 26.2" >> "$manifest_file"
    echo "" >> "$manifest_file"
