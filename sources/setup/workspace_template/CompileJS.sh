#!/bin/bash
# ============================================================================
# EaglerCraft 26.2 - Compile TeaVM JavaScript
# ============================================================================
#
...
# ---- Banner ----
echo -e "${CYAN}========================================${NC}"
echo -e "${CYAN} EaglerCraft 26.2 - CompileJS${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
# Check Minecraft jar
if [ ! -f "libs/minecraft-26.2.jar" ]; then
    echo -e "${YELLOW}[WARN]${NC} Minecraft jar not found: libs/minecraft-26.2.jar"
