@echo off
REM ============================================================================
REM EaglerCraft 26.2 - Compile EPK Assets (Windows)
REM ============================================================================
REM
...
REM ---- Banner ----
echo ========================================
echo  EaglerCraft 26.2 - Compile EPK
echo ========================================
echo.
...
if %ERRORLEVEL% neq 0 (
    ...
    if exist "build\classes\java\main\net\lax1dude\eaglercraft\v2_6\gui\EPKCompiler.class" (
        java -cp "build\classes\java\main;libs\minecraft-26.2.jar" --enable-preview net.lax1dude.eaglercraft.v2_6.gui.EPKCompiler "src\resources" "output\%OUTPUT_FILE%"
        if %ERRORLEVEL% neq 0 (
