@echo off
REM ============================================================================
REM EaglerCraft 26.2 - Compile TeaVM JavaScript (Windows)
REM ============================================================================
REM
...
REM   - minecraft-26.2.jar in libs/
REM
REM ============================================================================
...
REM ---- Banner ----
echo ========================================
echo  EaglerCraft 26.2 - CompileJS
echo ========================================
echo.
...
if not exist "libs\minecraft-26.2.jar" (
    echo [WARN] Minecraft jar not found: libs\minecraft-26.2.jar
