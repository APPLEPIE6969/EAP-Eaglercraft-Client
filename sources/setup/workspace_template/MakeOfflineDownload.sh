#!/bin/bash
# ============================================================================
# EaglerCraft 26.2 - Make Offline Download
# ============================================================================
#
...
# ---- Banner ----
echo -e "${CYAN}========================================${NC}"
echo -e "${CYAN} EaglerCraft 26.2 - Offline Download${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
<head>
    ...
    <meta name="description" content="EaglerCraft 26.2 - Offline Edition">
    <meta name="theme-color" content="#1a1a2e">
    <title>EaglerCraft 26.2 - Offline</title>
    <style>
...
<body>
    <div id="loading">
        <div class="ld-title">EaglerCraft 26.2</div>
