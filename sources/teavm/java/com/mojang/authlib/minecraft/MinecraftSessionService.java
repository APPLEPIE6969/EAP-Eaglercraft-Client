...
/**
 * EaglerCraft 26.2 browser stub for com.mojang.authlib.minecraft.MinecraftSessionService.
 * No real session service in the browser - authentication is handled by the gateway.
 *
 * NOTE: MC 26.2 changed fetchProfile(UUID, boolean) to return
...
public interface MinecraftSessionService {
        ...
        /**
         * MC 26.2: Fetches a profile result by UUID.
        ...
        /**
         * MC 26.2: Returns the packed textures Property for the given profile.
        ...
        /**
         * MC 26.2: Unpacks the textures Property into a MinecraftProfileTextures object.
