...
/**
 * EaglerCraft 26.2 browser override for InputConstants.
...
public class InputConstants {
        ...
        public enum Type {
                 ...
                 * Matches MC 26.2's getOrCreate(int) signature.
                 */
	...
	/**
	 * MC 26.2: Returns the display name Component for this key.
	...
	public net.minecraft.network.chat.Component getDisplayName() {
        ...
        /** MC 26.2 UNKNOWN Key singleton (static field). */
	...
	// ========== MC 26.2 input callback setup ==========

	/**
	 * MC 26.2: Grabs or releases the mouse cursor (Pointer Lock API in browser).
	 */
	...
	/**
	 * MC 26.2: Sets up keyboard callbacks (key, char, preedit, IME status).
	...
	/**
	 * MC 26.2: Sets up mouse callbacks (cursor pos, mouse button, scroll, drop).
