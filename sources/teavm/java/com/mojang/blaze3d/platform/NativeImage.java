...
/**
 * EaglerCraft 26.2 browser override for NativeImage.
...
public class NativeImage implements AutoCloseable {
        ...
        // ========== MC 26.2 Format enum + constructors + methods ==========

        /**
         * MC 26.2 NativeImage.Format enum.
        ...
        /**
         * MC 26.2: Constructor (width, height, useStb).
         */
        ...
        /**
         * MC 26.2: Constructor (Format, width, height, useStb).
         */
        ...
        /**
         * MC 26.2: Reads a NativeImage from stream with the given format.
         */
        ...
        /**
         * MC 26.2: Reads pixel at (x, y). Returns ARGB int.
         */
        ...
        /**
         * MC 26.2: Sets pixel at (x, y) to ARGB value.
         */
        ...
        /**
         * MC 26.2: Returns the entire image as an ARGB int[] array.
         */
        ...
        /**
         * MC 26.2: Computes the transparency type of this image.
         */
        ...
        /**
         * MC 26.2: Untracks this image from any native resource tracking.
