...
public interface RenderPass {
    ...
    default void draw(int baseVertex, int vertexCount, int startIndex, int instanceCount) {}
    default void setIndexBuffer(com.mojang.blaze3d.buffers.GpuBuffer buffer, com.mojang.blaze3d.IndexType indexType) {}
    ...
    default void drawIndexed(int baseVertex, int indexCount, int startIndex, int instanceCount, int vertexOffset) {}
    default void drawMultipleIndexed(java.util.Collection draws, com.mojang.blaze3d.buffers.GpuBuffer indexBuffer,
            com.mojang.blaze3d.IndexType indexType, java.util.Collection params, Object multiDrawData) {}
