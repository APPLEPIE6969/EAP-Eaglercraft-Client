...
/**
 * EaglerCraft 26.2 browser override for RenderSystem.
...
public class RenderSystem {
        ...
        public static String getApiDescription() {
                return "WebGL2 (EaglerCraft 26.2)";
        }

    // ===== MC 26.2 missing methods =====
    ...
    /** @deprecated Use the no-arg version. Kept for backward compatibility. */
    @Deprecated
    public static net.minecraft.util.TimeSource.NanoTimeSource initBackendSystem(
            com.mojang.blaze3d.platform.BackendOptions options) {
        return initBackendSystem();
    }
    ...
    public static void flipFrame(com.mojang.blaze3d.TracyFrameCapture capture) {
        ...
        // ========== MC 26.2 additional members ==========

        /**
         * MC 26.2: Size of the projection matrix UBO (uniform buffer object).
         * 16 floats * 4 bytes = 64 bytes per matrix.
         */
        public static final int PROJECTION_MATRIX_UBO_SIZE = 64;

        /**
         * MC 26.2: Executes any pending render-thread tasks.
    ...
    // MC 26.2: getSequentialBuffer with PrimitiveTopology
    public static AutoStorageIndexBuffer getSequentialBuffer(com.mojang.blaze3d.PrimitiveTopology topology) { return new AutoStorageIndexBuffer(); }
    ...
    public static class AutoStorageIndexBuffer {
        ...
        public com.mojang.blaze3d.IndexType type() { return com.mojang.blaze3d.IndexType.SHORT; }
    }

    public static org.joml.Matrix4f getModelViewMatrixCopy() { return new org.joml.Matrix4f(); }
