...
/**
 * EaglerCraft 26.2 browser override for com.mojang.blaze3d.vertex.PoseStack.
 *
...
public class PoseStack {
    ...
    public void translate(net.minecraft.world.phys.Vec3 vec) { translate(vec.x, vec.y, vec.z); }
}
