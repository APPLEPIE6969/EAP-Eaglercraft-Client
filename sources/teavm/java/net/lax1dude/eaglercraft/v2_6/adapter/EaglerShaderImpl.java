...
/**
 * Shader adapter that bridges Minecraft 26.2's shader system to WebGL2
 * through {@link PlatformOpenGL}.
 *
 * <p>In vanilla MC 26.2, shaders are compiled and managed through LWJGL's
 ...
 * <p>MC 26.2 desktop shaders typically use GLSL 1.20-1.50 syntax. WebGL2
 ...
 * <code>adapter</code> sub-package. MC 26.2's shader classes (e.g.,
 * {@code ShaderProgram}, {@code ShaderInstance}) will be patched to call
 * this adapter instead of LWJGL directly.</p>
 *
 * TODO: Update to actual MC 26.2 class names after decompilation.
...
public class EaglerShaderImpl {
         ...
         * @param title    the main title text (e.g. "EaglerCraftX 26.2")
