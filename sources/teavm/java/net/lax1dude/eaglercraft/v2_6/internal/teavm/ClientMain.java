...
/**
 * Client initialization and startup logic for EaglerCraft 26.2 TeaVM platform.
 * Handles browser feature detection, WebGL2 context creation, and client bootstrap.
 *
 * <p>Key 26.2 improvements:</p>
 * <ul>
...
public class ClientMain {
                ...
                try {
                        ...
                        if (webgl == null) {
                                showCrashScreen("WebGL2 is not supported by your browser!\n\n"
                                                + "EaglerCraft 26.2 requires WebGL2.\n"
                        ...
                        showCrashScreen("Failed to initialize EaglerCraft 26.2!\n\n" + t.getMessage());
                }
        }
         ...
         * optimized for EaglerCraft 26.2.
         */
        ...
        /**
         * Creates default WebGL2 context attributes optimized for EaglerCraft 26.2.
         */
        ...
        @JSBody(params = { "message" }, script = ""
                        ...
                        + "title.textContent = 'EaglerCraft 26.2 Crashed!';"
