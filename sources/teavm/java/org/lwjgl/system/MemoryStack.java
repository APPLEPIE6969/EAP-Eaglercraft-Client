...
public class MemoryStack {
    ...
    /**
     * MC 26.2: Allocates a PointerBuffer of the given size on this stack.
     */
    ...
    public long ncalloc(int alignment, int count, int size) { return 0; }
    public java.nio.LongBuffer callocLong(int count) { return java.nio.ByteBuffer.allocateDirect(count * 8).order(java.nio.ByteOrder.nativeOrder()).asLongBuffer(); }
    public org.lwjgl.PointerBuffer callocPointer(int count) { return new org.lwjgl.PointerBuffer(); }
    public java.nio.ByteBuffer ASCII(CharSequence s) { return java.nio.ByteBuffer.allocate(s.length()); }
    public java.nio.ByteBuffer UTF8(CharSequence s) { return java.nio.ByteBuffer.allocate(s.length()); }
    public org.lwjgl.PointerBuffer pointers(long... values) { return new org.lwjgl.PointerBuffer(); }
}
