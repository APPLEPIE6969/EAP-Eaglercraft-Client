...
public class MissingMethodTransformer implements ClassHolderTransformer {
    ...
    static {
        ...
        // invokeExact(Buffer) -> long (used by Netty to get Buffer.address())
        add("java.lang.invoke.MethodHandle", "invokeExact", ValueType.LONG,
            new ValueType[] { ValueType.object("java.nio.Buffer") }, 0L, false);
        ...
        // TeaVM can't find record accessor methods. Add type() explicitly.
        add("com.mojang.blaze3d.systems.DeviceInfo", "type",
            ValueType.object("com.mojang.blaze3d.systems.DeviceType"),
            new ValueType[0], null, false);

        // ===== org.lwjgl.vulkan.VkExtensionProperties$Buffer =====
        add("org.lwjgl.vulkan.VkExtensionProperties$Buffer", "stream",
            ValueType.object("java.util.stream.Stream"),
            new ValueType[0], null, false);

        // ===== java.lang.String =====
        // String.lines() returns Stream<String> - added in Java 11, missing from TeaVM classlib
        add("java.lang.String", "lines",
            ValueType.object("java.util.stream.Stream"),
            new ValueType[0], null, false);

        // ===== com.mojang.blaze3d.systems.DeviceInfo =====
        // All record accessors - TeaVM may not find them even from our class stub
        add("com.mojang.blaze3d.systems.DeviceInfo", "name",
            ValueType.object("java.lang.String"), new ValueType[0], "", false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "vendorName",
            ValueType.object("java.lang.String"), new ValueType[0], "", false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "driverInfo",
            ValueType.object("java.lang.String"), new ValueType[0], "", false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "isZZeroToOne",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "backendName",
            ValueType.object("java.lang.String"), new ValueType[0], "", false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "timestampPeriod",
            ValueType.FLOAT, new ValueType[0], 1.0f, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "limits",
            ValueType.object("com.mojang.blaze3d.systems.DeviceLimits"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "features",
            ValueType.object("com.mojang.blaze3d.systems.DeviceFeatures"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "underlyingExtensions",
            ValueType.object("java.util.Set"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "hintsAndWorkarounds",
            ValueType.object("com.mojang.blaze3d.systems.HintsAndWorkarounds"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.systems.DeviceInfo", "type",
            ValueType.object("com.mojang.blaze3d.systems.DeviceType"), new ValueType[0], null, false);

        // ===== com.mojang.blaze3d.systems.DeviceLimits =====
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxAnisotropy",
            ValueType.INTEGER, new ValueType[0], 0, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "minUniformOffsetAlignment",
            ValueType.INTEGER, new ValueType[0], 256, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxTextureSize",
            ValueType.INTEGER, new ValueType[0], 16384, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxMemoryAllocationSize",
            ValueType.LONG, new ValueType[0], 0L, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxMultiDrawDirectInterleavedDrawCount",
            ValueType.INTEGER, new ValueType[0], 0, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxColorAttachments",
            ValueType.INTEGER, new ValueType[0], 4, false);
        add("com.mojang.blaze3d.systems.DeviceLimits", "maxTextureSizeForFormat",
            ValueType.INTEGER,
            new ValueType[] { ValueType.object("com.mojang.blaze3d.GpuFormat") }, 16384, false);

        // ===== com.mojang.blaze3d.systems.DeviceFeatures =====
        add("com.mojang.blaze3d.systems.DeviceFeatures", "multiDrawIndirect",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.DeviceFeatures", "multiDrawBaseInstance",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.DeviceFeatures", "pipelineStatisticsQuery",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.DeviceFeatures", "timestampQuery",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.DeviceFeatures", "persistentMapping",
            ValueType.BOOLEAN, new ValueType[0], false, false);

        // ===== com.mojang.blaze3d.systems.HintsAndWorkarounds =====
        add("com.mojang.blaze3d.systems.HintsAndWorkarounds", "writeToBufferIsSlow",
            ValueType.BOOLEAN, new ValueType[0], false, false);
        add("com.mojang.blaze3d.systems.HintsAndWorkarounds", "anisotropyHasKnownIssues",
            ValueType.BOOLEAN, new ValueType[0], false, false);

        // ===== com.mojang.blaze3d.systems.GpuSurface$Configuration =====
        add("com.mojang.blaze3d.systems.GpuSurface$Configuration", "width",
            ValueType.INTEGER, new ValueType[0], 0, false);
        add("com.mojang.blaze3d.systems.GpuSurface$Configuration", "height",
            ValueType.INTEGER, new ValueType[0], 0, false);
        add("com.mojang.blaze3d.systems.GpuSurface$Configuration", "presentMode",
            ValueType.object("com.mojang.blaze3d.systems.GpuSurface$PresentMode"), new ValueType[0], null, false);

        // ===== com.mojang.blaze3d.pipeline.BlendFunction =====
        add("com.mojang.blaze3d.pipeline.BlendFunction", "srcColor",
            ValueType.object("com.mojang.blaze3d.platform.BlendFactor"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.pipeline.BlendFunction", "dstColor",
            ValueType.object("com.mojang.blaze3d.platform.BlendFactor"), new ValueType[0], null, false);
        add("com.mojang.blaze3d.pipeline.BlendFunction", "srcAlpha",
            ValueType.object("com.mojang.blaze3d.platform.BlendFactor"), new ValueType[0], null, false);
